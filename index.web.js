...
// Login screen using exact Figma export structure
const LoginScreen = () => {
  return (
    <div className="frame-1-1">
      ...
      <div className="rectangle-90-10"></div>
      <p className="text-11"><span className="text-rgb-253-245-221">Sign in</span></p>
      <p className="text-12"><span className="text-rgb-58-43-32">Create new account</span></p>
